...
**ONDE PARAMOS (17/09, 09:15) — ler isto primeiro ao retomar:**
- Etapa 2 concluída (§8.4). Passos 1 e 2 da Etapa 3 **concluídos**. **Passo 3 em andamento** (série rodando; se interrompida, rodar de novo `Rscript R/10_serie_confiabilidade.R` — retoma). Passo 4 **script pronto** (`R/11_triagem_confiabilidade.R`), testado com os trimestres já prontos — **rodar de novo quando a série terminar**. Depois: passo 5 (relatório de apoio para o usuário escolher o critério). Nada commitado ainda.
